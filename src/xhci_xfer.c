                    ...
                    PXHCI_XFER_EVENT_RESULT result)
{
    ...
    /* `CANCELED` cannot reach this or the two class tests below it - the
     * function returned on that class above - and the term is kept in each so
     * the class list reads complete; the branches are live for their other
     * terms (roadmap Phase 20, smaller items). */
