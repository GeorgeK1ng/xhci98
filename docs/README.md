...
- [Batch 13-E evidence](contributing/runs/run-13e-evidence/README.md) - the raw
  `XHCISNAP` captures behind that run sheet, and what each is durable evidence
  of: fourteen of them carry the full 18-port `PORTSC` table, healthy against
  wedged, which exists nowhere else.
- [Phase 20 run sheet](contributing/runs/run-20.md) - release `1.0.2.0`: the
  2026-09-05 audit's findings task by task, `usbui.dll`, the three re-cuts
  under one number, and every guest reading taken on the published binary.
